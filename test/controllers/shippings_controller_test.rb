...
class ShippingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping" do
    assert_difference('Shipping.count') do
      post shippings_url, params: { shipping: { description: @shipping.description, title: @shipping.title } }
    end
  ...
  test "should update shipping" do
    patch shipping_url(@shipping), params: { shipping: { description: @shipping.description, title: @shipping.title } }
